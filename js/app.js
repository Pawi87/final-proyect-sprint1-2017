...
function decipher(crypted) {
    ...
    for (i = 0; i < crypted.length; i++) {
        ...
        if (lettersCode >= 97 && lettersCode <= 122) {
            ...
            //para las minusculas se tomaran los datos del codigo de Ascii con el valor de 97 menos el modulo de 33 que son los espacios a la derecha del abc, modulo de 26 más 97. Se resta por que ahora se esta regresando los espacios que se avanzaron.
